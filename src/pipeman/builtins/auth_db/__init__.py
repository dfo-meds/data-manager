...
def init_plugin(system: _System):
    ...
    system.register_nav_item("me", "auth_db.me", "users.view_myself", "self")
    system.register_nav_item("me.change_password", "auth_db.change_password", "users.change_my_password", "self")
    system.register_nav_item("me.edit_profile", "auth_db.edit_profile", "users.edit_myself", "self")
