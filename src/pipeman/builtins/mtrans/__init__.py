...
def init_plugin(system: System = None, cfg: zr.ApplicationConfig = None):
    ...
    if te_cls == "pipeman.builtins.mtrans.mtrans.ManualTranslationEngine":
        ...
        system.register_nav_item("download_translations", "pipeman.menu.download_translations", "mtrans.download_translations", "translations.manage", weight=10000)
        system.register_nav_item("upload_translations", "pipeman.menu.upload_translations", "mtrans.upload_translations", "translations.manage", weight=10001)
